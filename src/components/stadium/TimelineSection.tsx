    ...
    <section className="py-32 bg-peach/30 border-y border-rose/10 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <ScrollReveal className="mb-32 text-center space-y-6">
          ...
          <div className="w-24 h-[1px] bg-rose/30 mx-auto mt-12" />
        </ScrollReveal>

        <div className="relative">
          {/* Central Line with improved styling */}
          <div className="absolute left-[30px] md:left-1/2 top-0 w-[2px] h-full bg-gradient-to-b from-rose/60 via-rose/20 to-transparent" />
          ...
          <div className="space-y-40">
            {timeline.map((item, i) => (
              <div key={i} className={`relative flex flex-col md:flex-row items-center ${i % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}>
                ...
                <div className="absolute left-[24px] md:left-1/2 md:-translate-x-1/2 top-4 md:top-1/2 md:-translate-y-1/2 z-20">
                   <div className="relative">
